...
from main import ask_ai, get_macros
...
def personal_data_form():
    with st.form("personal_data"):
        ...
        height = st.number_input("Height (cm)", min_value=50.0, max_value=250.0, step=1.0, value=float(profile["general"]["height"]),)
...
def goals_form():
    ...
    with st.form("goals_form"):
        ...
        # weight_goal = st.number_input("Weight Goal (kg)", min_value=1.0, max_value=300.0, step=0.1, value=float(goals["weight_goal"]),)
        # weight_goal_date = st.date_input("Weight Goal Date", value=goals["weight_goal_date"])
